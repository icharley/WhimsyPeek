...
const SessionModal = ({ session, onSave, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = session
        ? await sessionsAPI.update(session._id, sessionData)
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Add as many ideas as you want. Empty ideas will be automatically
                removed.
              </p>
            </div>
          </div>
